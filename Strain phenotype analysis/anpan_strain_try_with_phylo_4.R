...
setwd("/WORKAREA/home/sv437/strain_assc_anpan/strainphlan4_tre_new/")
...
write.csv(effect_size_phen,'effect_size_phen_strain_with_phylo_4.csv')
write.csv(pval_phen,'pval_phen_strain_with_phylo_4.csv')
write.csv(fdr_phen,'fdr_phen_strain_with_phylo_4.csv')
save.image('strain_with_phylo_all_4.RData')
