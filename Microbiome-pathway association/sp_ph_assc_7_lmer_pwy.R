...
write.csv(effect_size_phen,'effect_size_phen_7_lmer_pwy.csv')
write.csv(pval_phen,'pval_phen_7_lmer_pwy.csv')
write.csv(fdr_phen,'fdr_phen_7_lmer_pwy.csv')
#
